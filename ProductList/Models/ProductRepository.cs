...
namespace ProductList.Models
    ...
    public class ProductRepository
        ...
        public static List<Supplier> GetSuppliers()
        {
            ...
            {
                new Supplier{Id= 1, Name="Aliexpress"},
                new Supplier{Id= 2, Name="Alibaba"},
                new Supplier{Id= 3, Name="JackMabaso"},
                new Supplier{Id= 4, Name="China"},
    ...
    {
        new Category { Id = 1, Name = "Category 1", SupplierId = 4 },
        new Category { Id = 2, Name = "Category 2", SupplierId = 3 },
        new Category { Id = 3, Name = "Category 3", SupplierId = 4 },
